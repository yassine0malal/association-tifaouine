  ...
  async up(queryInterface) {
    ...
    const documents = [
      // ── 1. RAPPORT ────────────────────────────────────────────────────────
      {
        ...
        file_type:       'pdf',
        image_couverture: '/data/ressources/images/documents/couvertures/couverture-1776551479876-541452.jpg',
        is_featured:     true,
        created_at:      now,
        updated_at:      now,
      },
      ...
      // ── 2. GUIDE ──────────────────────────────────────────────────────────
      {
        ...
        file_type:       'pdf',
        image_couverture: '/data/ressources/images/documents/couvertures/couverture-1776552865509-689031.png',
        is_featured:     true,
        created_at:      now,
        updated_at:      now,
      },
