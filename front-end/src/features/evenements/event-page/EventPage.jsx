      ...
      <div className={styles.eventContentContainer}>
        <div className={styles.row1}>
          ...
          <div className={styles.details}>
            ...
            <div className={styles.eventAddImg} style={{backgroundImage:`url(${eventImg})`}}>
              <Link>Devenir un benevole</Link>
            </div>
          </div>
        </div>
        ...
        <div className={styles.row2}>
          <div className={styles.col1}>
            ...
            <p className={styles.description}>
              ...
              (like deep teal and warm accents shown here)
              <br />
              further enhances the beauty and readability of the interface. When
              representing your event images, this approach allows you to
              highlight key moments by mixing different photo aspect ratios and
              sizes, adding depth and narrative to the gallery section. The use
              of generous whitespace and a clean, professional color palette
              (like deep teal and warm accents shown here)
              <br />
              further enhances the beauty and readability of the interface. Ce
              projet representing your event images, this approach allows you to
              highlight key moments by mixing different photo aspect ratios and
              sizes, adding depth and narrative to the gallery section. The use
              of generous whitespace and a clean, professional color palette
              (like deep teal and warm accents shown here)
              <br />
              further enhances the beauty and readability of the interface. When
              representing your event images, this approach allowVotre soutien
              peut faire la différence. Chaque don, même le plus petit,
              contribue à améliorer des vies et à construire un avenir meilleur.
              Rejoignez-nous dans cette mission solidaire.
              <br />s you to highlight key moments by mixing different photo
